...
namespace EasySoft.PssS.Repository
{
    ...
    /// 采购项仓储接口
    /// </summary>
    public interface IPurchaseItemRepository: IBaseRepository<PurchaseItem, string>
    {
        /// <summary>
        /// 判断是否存在代码相同的采购项
        /// </summary>
        ...
        List<PurchaseItem> Search(string category, string isValid);
        ...
        /// <returns>返回采购项数据集合</returns>
        List<PurchaseItem> Search(string category, int pageIndex, int pageSize, ref int totalCount);
    }
}
