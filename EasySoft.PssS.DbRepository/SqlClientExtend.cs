...
namespace EasySoft.PssS.DbRepository
{
    ...
    /// Mssql数据库工具类
    /// </summary>
    internal class SqlClientExtend :IDbClientExtend
    {
        #region 分页Sql字符串
        ...
        public string GetPagingSqlString(string cmdText, int pageSize, int totalCount, int pageIndex, string orderByStr)
        {
